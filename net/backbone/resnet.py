...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, dilation=1, downsample=None, BatchNorm=None):
        ...
        self.conv2 = nn.Conv2d(inplanes, planes, kernel_size=3, stride=stride, dilation=dilation, padding=dilation, bias=False)
...
def ResNet34(output_stride, BatchNorm):
    model = ResNet(BasicBlock, [3, 4, 6, 3], output_stride, BatchNorm, pretrained=False)
    return model


def ResNet50(output_stride, BatchNorm):
    model = ResNet(Bottleneck, [3, 4, 6, 3], output_stride, BatchNorm, pretrained=False)
    return model
